...
@Autonomous(name="Crater side + Base")
public class Autonomous_Robot extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED, -23.5, -23.5, 1.05);
        encoderDrive(TURN_SPEED, 1.5, -1.5, .6);
        encoderDrive(DRIVE_SPEED, -3, -3, 0.7);
        encoderDrive(TURN_SPEED, 1.7, -1, 0.1);
        encoderDrive(DRIVE_SPEED, -35, -35, 1.8);
   ...
   /* public void encoderMotor(double speed,
        ...
        if (opModeIsActive()) {
            ...
            // Determine new target position, and pass to motor controller
            newTarget = robot..getCurrentPosition() + (int) (inches * COUNTS_PER_INCH);
